/* WASD FTW Library
 * @author zettix / http://zettix.com
 *
 * Based on THREE.FirstPersonControls by mrdoob et. al. http://mrdoob.com/
 *   Options to grab the mouse and such provided.
 *
3x3 touchgrid for mouse/mobile.
 */
...
WASD.Controls = function(object , domElement) {
  ...
  this.MoveForward = function(delta) {
    var adj = this.object.rotation.y - this.ninety_degrees;
    //console.log("Move forward!" + this.object.rotation.y);
    var cosy = Math.cos(adj);
    var siny = Math.sin(adj);
    this.object.position.x -= delta * cosy * this.velocity;
    this.object.position.z += delta * siny * this.velocity;
  };
  ...
  this.MoveLeft = function(delta) {
    this.object.rotation.y += delta * this.rotation_speed;
  };
